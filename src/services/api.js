...
export const loansAPI = {
  ...
  calculateExtensionFee: async (loanId, extensionDays) => {
    const response = await fetch(`${API_BASE_URL}/loan-extension/calculate-fee`, {
      method: 'POST',
      headers: createHeaders(),
  ...
  getExtensionStatus: async (loanId) => {
    const response = await fetch(`${API_BASE_URL}/loan-extension/status/${loanId}`, {
      method: 'GET',
      headers: createHeaders(),
    });
    return handleResponse(response);
  ...
  getExtensionHistory: async (loanId) => {
    const response = await fetch(`${API_BASE_URL}/loan-extension/history/${loanId}`, {
      method: 'GET',
      headers: createHeaders(),
    });
    return handleResponse(response);
