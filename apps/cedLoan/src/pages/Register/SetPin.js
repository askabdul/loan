...
const SetPin = () => {
  ...
  const handleSetPin = async (e) => {
    ...
    try {
      ...
      if (!personalInfo.firstName) {
        setError(
          "Personal information not found. Please go back and fill it in.",
        );
      ...
      showToast(
        "Account created successfully! Welcome to CEDI Loan.",
        "success",
      );
      navigate("/home");
    } catch (err) {
  ...
  const handlePinChange = (value, isConfirm = false) => {
    ...
    if (isConfirm) setConfirmPin(numericValue);
    else setPin(numericValue);
  };
            ...
            <div className="card cedi-card shadow-lg border-0">
              <div className="card-body p-4 p-md-5">
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted small mb-1">Step 4 of 4</p>
