  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Store token so AuthContext picks it up on reload
        localStorage.setItem("token", data.token);

        toast.success("Registration completed successfully!");
        // Hard redirect so AuthContext re-runs checkAuth with the new token
            ...
            <div className="card cedi-card">
              <div className="card-body p-4 p-md-5">
                <div className="text-center mb-4">
                  <h1 className="h2 fw-bold text-cedi-dark mb-2">
                    Identity Verification
                  </h1>
                  <p className="text-muted">
                    Upload your identification documents to complete your
                    registration
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row mb-4">
                    <div className="col-md-12 mb-4">
                      <h5 className="fw-medium text-cedi-dark mb-3">
                        Front of ID *
                      </h5>
                      <FileUploadBox
                        fieldName="idFront"
                    ...
                    {["national-id", "drivers-license"].includes(
                      documents.idType,
                    ) && (
                      <div className="col-md-12 mb-4">
                        <h5 className="fw-medium text-cedi-dark mb-3">
                  ...
                  <div
                    className="alert alert-info border-primary"
                    style={{
